...
Here we look to test the impact of time lag when calculating the growth rate, r, and carrying capacity K
...
## Plot of the model with r dependent on $R_t$ and $R_{t-1}$

```{r 3aplot, results='hide', echo=FALSE, warning=FALSE}
...
## Plot of the model with K dependent on $R_t$ and $R_{t-1}$

```{r 3bplot, results='hide', echo=FALSE, warning=FALSE}
grid.arrange(plot3, plot4, ncol = 2)
```

## A table of $\alpha_0$ and $\alpha_1$ values
