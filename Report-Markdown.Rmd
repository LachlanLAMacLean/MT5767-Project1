...
This arises to the model fit displayed in Figure 4. Table 3 displays the coefficient values for the equations above for the model in addition to those found in the optimal models using only a single non constant variable to allow for comparison.
